...
# Script para configurar el frontend completo de PIAP
# Ejecutar desde: /Users/edegantea/development/maewalliscorp/gestionproyectos/frontend/

echo "🚀 Configurando frontend de PIAP..."
...
echo "   npm install zustand axios react-router-dom"
echo ""
