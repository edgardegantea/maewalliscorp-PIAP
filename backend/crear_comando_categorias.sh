...
echo "📦 Creando comando para datos de ejemplo..."

# Crear directorio para management commands
mkdir -p apps/projects/management/commands

# Crear __init__.py
touch apps/projects/management/__init__.py
touch apps/projects/management/commands/__init__.py

# Crear comando seed_categories
cat > apps/projects/management/commands/seed_categories.py << 'EOF'
...
echo ""
echo "✅ Comando creado exitosamente!"
echo ""
echo "Para ejecutar el comando:"
echo "  cd backend"
echo "  python manage.py seed_categories"